...
import batch.config.listener.BatchJobListener;
import batch.config.processor.EncodingCorrectionProcessor;
import batch.config.processor.ScpiItemProcessor;
import batch.config.reader.ScpiItemReader;
import batch.dto.BatchDataDto;
import batch.dto.ScpiDto;
import batch.entity.Scpi;
import batch.repository.ScpiRepository;
